          ...
          <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <div className="flex gap-3">
                <a 
                  href="https://www.instagram.com/brutonscigarshop" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className={`${mutedTextClasses[backgroundColor]} hover:${textClasses[backgroundColor]} transition-colors`}
                ...
                <a 
                  href="https://www.facebook.com/brutonscigarshop" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className={`${mutedTextClasses[backgroundColor]} hover:${textClasses[backgroundColor]} transition-colors`}
