    ...
    <div className="min-h-dvh bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <div className="px-4 py-8">
        ...
        <div className="text-center mb-8">
          <Link 
            href="/pwa"
            className="inline-flex items-center text-blue-600 dark:text-blue-400 mb-4 hover:text-blue-700 dark:hover:text-blue-300"
          >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Sign in with your Google account to access all features. It's free and takes just seconds.
          </p>
